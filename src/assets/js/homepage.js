import backPic1 from '../picture/background1.jpg'
import backPic2 from '../picture/background2.jpg'
import backPic3 from '../picture/background3.jpg'
import backPic4 from '../picture/background4.jpg'
...
export default function homepage(){
  ...
  $(window).scroll(function () {
    ...
    if (faceTop < height * 0.1 && faceBottom > 0) {
      ...
      this.$refs.HomeFace.src =  backPic1
    ...
    if (offsetIntro1Top < height * 0.1 && offsetIntro1Bottom > 0) {
      ...
      this.$refs.HomeFace.src =  backPic4
      $(".homepage-background").css("background-size", "120% 120%");
    }
    ...
    if (offsetIntro2Top < height * 0.1 && offsetIntro2Bottom > 0) {
      ...
      this.$refs.HomeFace.src =  backPic2
      $(".homepage-background").css("background-size", "120% 120%");
    }
    ...
    if (offsetIntro3Top < height * 0.1 && offsetIntro3Bottom > 0) {
      ...
      this.$refs.HomeFace.src =  backPic3
      $(".homepage-background").css("background-size", "120% 120%");
    }
  })  
}
